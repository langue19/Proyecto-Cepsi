                            ...
                            <table id="table-id" class="table table-striped table-dark">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th>Estado</th>
                                        <th>Acciones</th>
                                        <th><a href='AgregarProf.php'><img src='/Proyecto-master/Proyecto-master/img/mas.png' style="max-width: 30px;"></a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    <div class=''>
                                        <table class=''>
                                            <thead>
                                                ...
                                                <?php
                                                $idviejo = $row['ID'];
                                                $sql2 = "SELECT * FROM datos_Profesor WHERE ID = :idviejo"; // Usamos parámetros con consultas preparadas
