...
<body>
    ...
    overflow: hidden;
    color: lightgrey;">
                            <li class="active" id="account"><strong>Estado</strong></li>
                            ...
                            <div class="form-card">
                                <div class="row">
                                    ...
                                    if (isset($_GET['id'])) {
                                        ...
                                        $sql = "SELECT * FROM Datos_personales WHERE Dni = :id";
                                    ...
                                    <input style="background-color: antiquewhite; text-align:center;" value="<?php echo isset($registro['Dni']) ? $registro['Dni'] : ''; ?>" name="dni" type="text" class="fieldlabels" id="dni" readonly>
                ...
                </div> <input type="button" name="next" class="next action-button" value="Finalizar" />
                <a href="formularioAlumno.php" class="previous action-button-previous" style="text-decoration: none;">Cancelar</a>                </fieldset>
